...
plt.plot(curve_xx,U_prime_curve,"b", label="$U'(x)$")
plt.plot(curve_xx,U_fun_curve,"r", label="$U(x)$")
...
plt.savefig('u_fun_and_u_prime.eps', format='eps')
...
plt.savefig('distribution_bandwidth_kernel_O3.eps', format='eps')
...
plt.legend(fontsize=15)
plt.savefig('distribution_bandwidth_kernel_O5_1.eps', format='eps')
...
plt.legend(fontsize=15)
plt.savefig('distribution_bandwidth_kernel_O5_2.eps', format='eps')
...
plt.savefig('density_simu_particle5.eps', format='eps')
...
plt.savefig('density_simu_particle10.eps', format='eps')
...
plt.savefig('density_simu_particle15.eps', format='eps')
